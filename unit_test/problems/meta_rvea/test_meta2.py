...
# Inner problem: DLTZ7
# Hyperparameters: all instances' reference vectors
# Strategy: optimize all instances' reference vectors
# Result of n_objs = 3 (IGD): 0.0480
# Result of n_objs = 5 (IGD): 0.2109
# Result of n_objs = 10 (IGD): 0.8400
# Result of n_objs = 15 (IGD): 1.7585
...
class InnerRVEAa(Algorithm):
    ...
    def __init__(
        ...
        v = torch.cat([v, torch.rand((self.pop_size, self.n_objs), device=device)], dim=0)
