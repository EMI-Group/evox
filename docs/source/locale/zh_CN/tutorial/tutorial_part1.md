...
- **丰富的算法库和问题库**：EvoX 内置了30+种单目标和多目标演化算法，以及30+种基准优化问题，而更广泛的 EvoX 生态——由 EvoX 与 13 个相关的 GPU 加速演化计算库共同组成——则提供了140+个算法和240+个基准问题与环境。无论是经典函数优化、复杂工程问题，还是机器学习中的超参数优化（HPO）和神经进化（Neuroevolution），EvoX 都提供了相应的算法和问题接口，开箱即用。
