...
## 🔥 News
- [2025-03-31] Released **EvoX 1.2.0** - 🚀 EvoX v1.2.0 is out with new features like Mujoco Playground, and an official tutorial! [[Details](https://evox.group/index.php?m=home&c=View&a=index&aid=157)]
