...
class SHADE(Algorithm):
    ...
    def __init__(
        ...
        # parameters
        self.num_diff_vects = Parameter( torch.tensor(1), device=device )
        # set value
    ...
    def step(self):
        ...
        trial_vector = de_bin_cross( mutation_vector, current_vect, CR_vect )
        ...
        population_update = torch.where( compare[:, torch.newaxis], trial_vector, self.population )
