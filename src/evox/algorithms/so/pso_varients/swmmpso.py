...
from evox.algorithms.so.pso_varients.topology_utils import get_circles_neighbour, get_neighbour_best_fitness, build_adjacancy_list_from_matrix
...
class SwmmPSO(Algorithm):
    ...
    def tell(self, state, fitness):
        ...
        neighbour_best_fitness, neighbour_best_indice = get_neighbour_best_fitness(fitness = local_best_fitness, adjacancy_list=neighbour_list)
