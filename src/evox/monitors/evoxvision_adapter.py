...
def new_exv_metadata(
    population1: jax.Array,
    population2: jax.Array,
    fitness1: jax.Array,
    fitness2: jax.Array,
):
...
class EvoXVisionAdapter:
    def __init__(
        ...
        ----------
        file_path
            The path to the exv file
        buffering
            The buffer size to use for file operations, passed directly to the `open()` function.
    ...
    def write_header(self):
        ...
        ), "Metadata must be set before writing the header."
